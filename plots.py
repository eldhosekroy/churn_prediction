...
for col in columns_to_display:
    ...
    display(pd.Series(enrolled[col].unique()))
...
display(enrolled_with_notes[['Contact Id', 'Note Content', 'Program Joined', 'inferred_status_notes', 'inferred_reason_notes']].head())
...
display(enrolled[['Contact Id', 'Program Joined', 'final_inferred_status', 'final_inferred_reason']].head())

print("\nDistribution of Final Inferred Status:")
display(enrolled['final_inferred_status'].value_counts())

print("\nDistribution of Final Inferred Reason:")
display(enrolled['final_inferred_reason'].value_counts())
...
display(enrolled['churn'].value_counts())
...
display(enrolled_for_model.head())
print("\nDistribution of 'churn' in enrolled_for_model:")
display(enrolled_for_model['churn'].value_counts())
...
display(enrolled_for_model[['Contact Id', 'final_inferred_reason', 'joined_competitor', 'not_interested', 'no_notes_provided', 'Invoice', 'Invoice_binary']].head())
...
display(filtered_churn_reasons)
